...
author = 'あなたの名前をここにどうぞ．／Your name here'

doc = """
クイズアプリはスプレッドシートから質問を読み込みます．（quiz.csvを参照して下さい．）
1ページに付き，1つの質問を表示します.
質問はcsvファイルの中にあります．
質問の順番をランダム化する方法は，以下のコメントをご覧ください．
...
class Constants(BaseConstants):
    ...
    with open('quiz/quiz.csv', encoding='utf-8') as f:
